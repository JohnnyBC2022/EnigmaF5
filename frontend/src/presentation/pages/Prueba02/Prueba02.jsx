        ...
        <div className="info-container">
          <span className="text-container">
            <p>
              ...
              mensajes enviados a través de enigma. Entre el grupo de expertos
              se encontraba Alan Turing, el creador de la máquina Bombe, que
              pudo descodificar los mensajes.
            </p>
          ...
          <div className="hint-container">
            ...
            <span className="hint-text">
              <p>
                ...
                electrónico con el asunto "Manual Bombe" a{" "}
                <a
                  href="mailto:enigmaf5.aspirantes@gmail.com"
                  style={{ color: "#993f2a", textDecoration: "underline" }}
                >
                  enigmaf5.aspirantes@gmail.com
                </a>
                , indicando en el cuerpo del correo el nombre de las personas
                participantes de vuestro grupo. Revisad la carpeta de spam si
                pasados unos minutos no recibís el acceso al manual.
              </p>
            </span>
          </div>
        </div>
